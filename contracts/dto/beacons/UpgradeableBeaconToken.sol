...
contract UpgradeableBeaconToken is UpgradeableBeacon {
    ...
    // Mapping of DTO Implementation Token and their respective DTO IDs public dtoImplementationToken;
    mapping(uint256 id => address implementation) public dtoImplementationTokens;
    /**
    ...
    constructor(address implementation_) UpgradeableBeacon(implementation_) {
        ++ids;
        dtoImplementationTokens[ids] = implementation_;
    }
    ...
    function upgradeTo(address newImplementation) public override onlyOwner {
        ++ids;
        dtoImplementationTokens[ids] = newImplementation;
