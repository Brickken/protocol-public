 ...
 */
/// @title DTOTokenCheckpointsUpgradeable
/// @custom:security-contact tech@brickken.com
abstract contract DTOTokenCheckpointsUpgradeable is Initializable, ERC20BurnableUpgradeable {
    ...
    function getPastBalance(address account, uint256 blockNumber) public view virtual returns (uint256) {
        require(blockNumber < block.number, "DTOTokenCheckpoints: block not yet mined");
    ...
    function __DTOTokenCheckpoints_init(string calldata _name, string calldata _symbol) internal {
    ...
    function _mint(address account, uint256 amount) internal virtual override {
        require(totalSupply() + amount <= uint256(_maxSupply()), "DTOTokenCheckpoints: total supply risks overflowing");
