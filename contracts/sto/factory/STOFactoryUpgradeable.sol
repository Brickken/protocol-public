    ...
    UUPSUpgradeable
{
    ...
    address public constant OFFCHAIN_PRICE_SIGNER = address(0x976EA74026E726554dB657fA54763abd0C3a0aa9); // Address of the Offchain Price Report Signer
    ...
    function _newTokenization(
        ...
        {
            _chargeFee(issuer, priceReport, permit);
    ...
    function _chargeFee(
        ...
        if (amountToPay > 0) {
            if(permit.deadline > 0) IERC20PermitUpgradeable(bkn).permit(
                permit.signer,
                permit.spender,
                permit.amount,
                permit.deadline,
